    ...
    <div id="consoleRow">
      <div class="panel panel-default" id="consoleContent">
        <div class="panel-heading">
          <h3 class="panel-title pull-left" id="panel-title"><span class="glyphicon glyphicon-console" id="glyphicon-consoleImg"></span> Console</h3>
        </div>
      ...
      <div class="input-group" id="consoleCommand">
        <span class="input-group-addon">
          <input id="chkAutoScroll" type="checkbox" checked="true" autocomplete="off" /><span class="glyphicon glyphicon-arrow-down" id="glyphicon-autoScroll"></span>
        </span>
